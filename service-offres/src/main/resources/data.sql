...
INSERT INTO geo(idGeo, latitude, longitude)
VALUES (1, 50.23, 79.23);
INSERT INTO geo(idGeo, latitude, longitude)
VALUES (2, 20.26, 11.01);
INSERT INTO geo(idGeo, latitude, longitude)
VALUES (3, 90.29, 89.72);

INSERT INTO personne(idPersonne, nom, prenom)
VALUES (1, 'TONDON', 'César');
INSERT INTO personne(idPersonne, nom, prenom)
VALUES (2, 'CISTERNINO', 'Enzo');

INSERT INTO Adresse(idAdresse, adressePays, adresseVille, codePostal, adresseRue)
VALUES (1, 'France', 'Nancy', '54000', '53 rue des jardiniers');
INSERT INTO Adresse(idAdresse, adressePays, adresseVille, codePostal, adresseRue)
VALUES (2, 'France', 'Epinal', '88300', '12 rue des étoiles');

INSERT INTO LieuStage(idLieuStage, idAdresse, telephone, url, idGeo)
VALUES (1, 1, 0630771158, 'https://fake-recrute.com', 1);
INSERT INTO LieuStage(idLieuStage, idAdresse, telephone, url, idGeo)
VALUES (2, 2, 0720721440, 'https://fake-recrute-jamais.com', 2);

INSERT INTO Organisation(idOrganisation, nomOrganisation, idAdresse, email, telephone, url)
VALUES (1, 'Sample Entreprise', 1, 'sample@entreprise.com', 0387998898, 'https://sample-entreprise.com');
INSERT INTO Organisation(idOrganisation, nomOrganisation, idAdresse, email, telephone, url)
VALUES (2, 'Amazon Entreprise', 2, 'contact@amazon.com', 03275968898, 'https://amazon.com');

INSERT INTO Offre (idOffre, nomStage, domaine, descriptionStage, datePublicationOffre, niveauEtudesStage,
                   experienceRequiseStage, dateDebutStage, dureeStage, salaireStage, indemnisation, idOrganisation,
                   idLieuStage)
VALUES (1, 'Développeur Python', 'Développement Informatique', 'Automatisation de processus', '2023-01-23', 5, 2,
        '2023-04-01', 6, 1263.56, 125.98, 1, 1);

INSERT INTO Offre (idOffre, nomStage, domaine, descriptionStage, datePublicationOffre, niveauEtudesStage,
                   experienceRequiseStage, dateDebutStage, dureeStage, salaireStage, indemnisation, idOrganisation,
                   idLieuStage)
VALUES (2, 'Architecte SI', 'Conception SI informatique', 'Refonte du SI', '2023-01-10', 5, 10, '2023-09-01', 12,
        2263.56, 525.98, 2, 2);

INSERT INTO Candidature(idCandidature, idPersonne, idOffre, dateCandidature)
VALUES (1, 1, 1, '2023-02-28');
INSERT INTO Candidature(idCandidature, idPersonne, idOffre, dateCandidature)
VALUES (2, 2, 2, '2023-03-01');
INSERT INTO Candidature(idCandidature, idPersonne, idOffre, dateCandidature)
VALUES (3, 1, 2, '2023-03-02');